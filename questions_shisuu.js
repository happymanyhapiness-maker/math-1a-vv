...
explain: {
aim: "4^xを2^xの累乗として書き換える変形(2倍と2乗の混同回避)ができるかを測る問題。",
...
explain: {
aim: "(A+B)²の展開を使って、4^x+4^(-x)をtの式に正確に変形できるかを測る問題。",
...
explain: {
aim: "4^x=(2^x)²という関係を、具体的な数値に正しく適用できるかを測る問題。",
why: "4^x=(2^x)²=3²=9。",
...
explain: {
aim: "真数条件(真数>0、等号を含まない)を正しく立てられるかを測る問題。",
