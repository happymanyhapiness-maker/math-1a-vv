...
why: "$150°=180°-30°$。基準角は$30°$で、$150°$は第2象限にある。第2象限ではsinは正なので、$\\sin150°=\\sin30°=1/2$。",
mistake: "sinとcosの値を取り違えて$\\sqrt{3}/2$としたり、第2象限でsinが正であることを忘れて$-1/2$としてしまうことがある。",
...
why: "$120°=180°-60°$。基準角は$60°$で、$120°$は第2象限にある。cosはx座標なので、第2象限では負。したがって$\\cos120°=-\\cos60°=-1/2$。",
mistake: "符号を付け忘れて$1/2$としたり、基準角を$30°$と勘違いして$\\sqrt{3}/2$系の値を選んでしまうことがある。",
...
weakness: "方針切替",
route: ["相互関係", "象限での符号確認"],
q: "$\\sin\\theta=3/5$（$\\theta$は第2象限の角）のとき、$\\cos\\theta$ の値を求めよ。",
a: ["-4/5", "4/5", "-3/5", "3/5"],
correct: 0,
tags: ["correct", "condition_misread", "concept_gap", "concept_gap"],
explain: {
aim: "相互関係$\\sin^2\\theta+\\cos^2\\theta=1$で値を出したあと、象限の条件で符号を確定できるかを測る問題。",
why: "$\\cos^2\\theta=1-(3/5)^2=1-9/25=16/25$ より $\\cos\\theta=\\pm4/5$。$\\theta$は第2象限の角なのでcosは負。したがって$\\cos\\theta=-4/5$。",
mistake: "公式で$\\pm4/5$まで出したあと、問題文の『第2象限』という条件を見落として正の$4/5$を選んでしまう。",
...
mistake: "加法定理の符号を間違えて$\\sin(a-b)$の式($(\\sqrt6-\\sqrt2)/4$、これは$\\sin15°$)と混同してしまう。",
...
why: "倍角公式$\\cos2\\theta=2\\cos^2\\theta-1$を変形すると$2\\cos^2\\theta=1+\\cos2\\theta$。よって$\\cos^2\\theta=(1+\\cos2\\theta)/2$。",
mistake: "sin²の半角公式($(1-\\cos2\\theta)/2$)と混同してマイナスにしてしまう。",
...
mistake: "$\\cos(a+b)$の符号を$+$にしてしまい、$\\sin75°$の値($(\\sqrt6+\\sqrt2)/4$)と取り違える。",
