...
tip: "a^2-1 か 1-a^2 か迷ったら、θ=0(a=1, sin2θ=0)を代入して検算する。"
}
},
{
id: "q1-3",
...
weakness: "共通点抽出",
route: ["共通点の抽出"],
q: "半径5の円に内接する3つの三角形P、Q、Rについて、1辺の長さaと、その辺の対角のsinの値を調べたところ、次のようになった。\n三角形P: a=6, 対角のsin=3/5\n三角形Q: a=8, 対角のsin=4/5\n三角形R: a=5, 対角のsin=1/2\nこの3つすべてに共通して成り立つことはどれか。",
...
explain: {
why: "正弦定理より、a÷(対角のsin)=2R(外接円の直径)が成り立つ。\n\n3つとも同じ半径5の円に内接しているので、この値は必ず2×5=10で一致する。\n\n実際に計算しても、6÷(3/5)=10、8÷(4/5)=10、5÷(1/2)=10で、すべて10になる。",
...
weakness: "共通点抽出",
route: ["共通点の抽出", "面積"],
q: "次の3つの三角形について、2辺の長さと、その間の角のsinの値が分かっている。\n三角形P: 2辺が4と5、間の角のsin=1/2\n三角形Q: 2辺が2と10、間の角のsin=1/2\n三角形R: 2辺が5と8、間の角のsin=1/4\nこの3つすべてに共通して成り立つことはどれか。",
...
mistake: "PとQを見ると、sinがどちらも1/2、2辺の積がどちらも20なので、②や③を共通点と誤認しやすい。しかしRはsin=1/4、積=40で、どちらも崩れる。最初の2つが一致すると、3つ目の確認を省略しがちになる。",
